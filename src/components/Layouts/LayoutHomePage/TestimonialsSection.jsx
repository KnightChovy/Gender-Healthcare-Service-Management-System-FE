        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-50 p-6 rounded-xl">
            ...
            <p className="text-gray-600 italic mb-5">
              "Tôi rất hài lòng với dịch vụ tại GenCare. Các bác sĩ rất chuyên
              nghiệp và thân thiện, tôi cảm thấy thoải mái khi trao đổi về các
              vấn đề nhạy cảm."
            </p>
          ...
          <div className="bg-gray-50 p-6 rounded-xl">
            ...
            <p className="text-gray-600 italic mb-5">
              ...
              chuyên nghiệp. Tôi đánh giá cao sự riêng tư và bảo mật thông tin
              mà trung tâm mang lại."
            </p>
            <div className="flex items-center">
              <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center mr-3">
          ...
          <div className="bg-gray-50 p-6 rounded-xl">
            ...
            <p className="text-gray-600 italic mb-5">
              "Dịch vụ tư vấn tâm lý tại GenCare đã giúp tôi hiểu rõ hơn về bản
              thân và vượt qua những lo lắng về sức khỏe giới tính. Rất chuyên
              nghiệp!"
            </p>
            <div className="flex items-center">
              <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center mr-3">
