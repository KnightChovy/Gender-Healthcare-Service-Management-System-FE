                    ...
                    appointmentData.map((latestAppointment) => {
                        if (latestAppointment.status === "rejected") {
                            const cancelNotification = {
                                ...
                                message: `Lịch hẹn ${latestAppointment.consultant_type || ''} đã bị quản lý từ chối. Vui lòng liên hệ hỗ trợ để biết thêm chi tiết.`,
                                timestamp: Date.now(),
                                isRead: false,
                            ...
                            if (!hasPaymentNotif) {
                                const paymentNotification = {
                                    ...
                                    message: `Lịch hẹn ${latestAppointment.consultant_type
