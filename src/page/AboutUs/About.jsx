              ...
              <div className="vision-mission">
                <div className="mb-8">
                  ...
                  <p className="text-lg text-gray-700 mb-6">
                    ...
                    chăm sóc sức khỏe giới tính toàn diện và giáo dục giới tính
                    cho mọi lứa tuổi tại Việt Nam, được công nhận bởi chất lượng
                    dịch vụ, đội ngũ chuyên gia uy tín và tác động tích cực đến
                    cộng đồng.
                  </p>
                  <p className="text-lg text-gray-700">
                    Chúng tôi hướng tới việc xóa bỏ các rào cản và định kiến xã
                    hội về vấn đề sức khỏe giới tính, tạo ra một môi trường an
                    toàn và cởi mở để mọi người có thể tiếp cận thông tin và
                    dịch vụ chăm sóc sức khỏe một cách đầy đủ và tự tin.
                  </p>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <p className="text-lg text-gray-700 mb-6">
                    Cung cấp dịch vụ chăm sóc sức khỏe giới tính chất lượng cao,
                    đáng tin cậy và toàn diện, đồng thời thúc đẩy giáo dục giới
                    tính khoa học và phù hợp với văn hóa để nâng cao chất lượng
                    cuộc sống và sức khỏe cộng đồng.
                  </p>
                  <ul className="list-disc pl-6 text-lg text-gray-700 space-y-2">
                    <li>
                      Cung cấp dịch vụ y tế chuyên nghiệp và tôn trọng riêng tư
                      của khách hàng
                    </li>
                    <li>
                      Cung cấp thông tin và kiến thức chính xác, khoa học về sức
                      khỏe giới tính
                    </li>
                    <li>
                      Tạo môi trường an toàn và không phán xét cho mọi đối tượng
                    </li>
                    <li>
                      Đồng hành cùng cộng đồng trong việc xây dựng văn hóa giới
                      tính lành mạnh
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-blue-50 p-6 rounded-lg">
                      ...
                      <p className="text-gray-700">
                        Lắng nghe và thấu hiểu nhu cầu của từng cá nhân để cung
                        cấp dịch vụ phù hợp nhất.
                      </p>
                    </div>
                    <div className="bg-blue-50 p-6 rounded-lg">
                      <h3 className="text-xl font-semibold text-blue-700 mb-2">
                      ...
                      <p className="text-gray-700">
                        Cung cấp thông tin y khoa chính xác và dịch vụ đáng tin
                        cậy theo tiêu chuẩn quốc tế.
                      </p>
                    </div>
                    <div className="bg-blue-50 p-6 rounded-lg">
                      <h3 className="text-xl font-semibold text-blue-700 mb-2">
                      ...
                      <p className="text-gray-700">
                        Không ngừng cải tiến dịch vụ và phương pháp giáo dục để
                    ...
                    <div className="bg-blue-50 p-6 rounded-lg">
                      ...
                      <p className="text-gray-700">
                        Cam kết với trách nhiệm xã hội và đóng góp tích cực vào
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white shadow-md rounded-lg overflow-hidden">
                      ...
                      <div className="p-4">
                        ...
                        <p className="text-gray-600 mt-2">
                          Phụ trách các chương trình đào tạo, giáo dục và truyền
                          thông
                        </p>
                      </div>
                    </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white shadow-md rounded-lg overflow-hidden">
                      ...
                      <div className="p-4">
                        <p className="text-gray-600">
                          Quản lý nhân sự, hành chính và các hoạt động vận hành
                          trung tâm
                        </p>
                        <p className="font-semibold mt-2">
              ...
              <div className="recruitment-info">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-lg text-gray-700">
                    ...
                    thiện và nhiều cơ hội phát triển nghề nghiệp trong lĩnh vực
                    y tế hiện đại.
                  </p>
                </div>
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6">
                      ...
                      <div className="mb-3">
                        <p className="text-gray-700 mb-2">
                          ...
                          Khám và điều trị bệnh lý sản phụ khoa, tư vấn sức khỏe
                          sinh sản cho bệnh nhân.
                        </p>
                        <p className="text-gray-700 mb-2">
                          <span className="font-semibold">Yêu cầu:</span> Bác sĩ
                          chuyên khoa I/II về Sản phụ khoa, tối thiểu 3 năm kinh
                          nghiệm.
                        </p>
                        <p className="text-gray-700">
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6">
                      ...
                      <div className="mb-3">
                        <p className="text-gray-700 mb-2">
                          ...
                          Tư vấn tâm lý liên quan đến sức khỏe giới tính, hỗ trợ
                          khách hàng giải quyết các vấn đề tâm lý.
                        </p>
                        <p className="text-gray-700 mb-2">
                          <span className="font-semibold">Yêu cầu:</span> Bằng
                          Thạc sĩ Tâm lý học lâm sàng, 2 năm kinh nghiệm tư vấn.
                        </p>
                        <p className="text-gray-700">
                          <span className="font-semibold">Quyền lợi:</span>{" "}
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6">
                      ...
                      <div className="mb-3">
                        ...
                        <p className="text-gray-700 mb-2">
                          ...
                          nghiệp đại học ngành Y tế công cộng, Giáo dục, Xã hội
                          học hoặc tương đương.
                        </p>
                        <p className="text-gray-700">
                          <span className="font-semibold">Quyền lợi:</span>{" "}
                          Lương từ 12-18 triệu đồng/tháng, thời gian linh hoạt,
                          phụ cấp đi lại.
                        </p>
                      </div>
                      <button className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded transition duration-200">
                ...
                <div className="mb-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
                    <div className="bg-gray-50 p-5 rounded-lg">
                      ...
                      <h4 className="text-lg font-semibold mb-2">Nộp hồ sơ</h4>
                    ...
                    <div className="bg-gray-50 p-5 rounded-lg">
                      ...
                      <h4 className="text-lg font-semibold mb-2">Nhận việc</h4>
                      <p className="text-gray-600 text-sm">
